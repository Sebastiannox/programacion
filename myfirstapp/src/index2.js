...
export function ListPaddockManagerIds() {
  let arrayIdPaddockManager = paddockManagers.map((paddockManager) => paddockManager.id);
  console
  return arrayIdPaddockManager;
}
export function ListPaddockManagersByName() {
